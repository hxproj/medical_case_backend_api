...
set_A = set(['Ⅴ类洞','Ⅰ类洞','浅龋','中龋','后牙复合树脂修复','后牙银汞合金修复'
             ...
             ,'患牙有充填修复史，但龋坏未累及旧修复体','3指宽','无','正常','低风险患者','患牙无充填修复史', '浅龋以下'])

set_B = set(['Ⅱ类洞','Ⅲ类洞','Ⅳ类洞','Ⅵ类洞','根面龋(累及唇颊面)','深龋','前牙复合树脂修复','龋坏累及旧修复体或旧修复体首次折裂','2指宽','有','较多','中风险患者'])

set_C = set(['后牙远中邻面龈方1/3洞','磨耗牙','牙尖缺损','严重缺损的残冠','猛性龋','根面龋(累及2个面以上)','年轻恒牙深龋','前牙无创美容修复'
                ,'前牙微创复合树脂分层修复','前牙微创CAD/CAM瓷贴面修复','后牙复合树脂嵌体'
                ,'后牙CAD/CAM瓷嵌体修复','患牙的旧修复体脱落2次或2次以上','2指宽以下','强烈','非常多','高风险患者'])
