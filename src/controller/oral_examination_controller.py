...
def _form_to_oral_examination(form):
    ...
    temp_oral_examination.cold_delay = form['cold_delay']
    temp_oral_examination.hot = form['hot']
    temp_oral_examination.hot_delay = form['hot_delay']
    ...
    temp_oral_examination.X_Ray_Visible = form['X_Ray_Visible']
    temp_oral_examination.X_Ray_fill_round = form['X_Ray_fill_round']
